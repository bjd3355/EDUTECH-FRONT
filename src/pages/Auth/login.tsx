...
import edutechLogo from '../../assets/logoedutech.jpg'; // Ajustement du chemin du logo
...
const menuItems: MenuItem[] = [
  ...
  { name: "Classes Virtuelles", icon: <FaBell /> }, // Classes Virtuelles avec icône de cloche (suppression de l'espace superflu)
...
// Définition du composant Admin (renommé Login si nécessaire)
      ...
      <header className="bg-blue-100 shadow-md p-4 flex items-center justify-between"> {/* En-tête avec fond bleu clair et ombre */}
        ...
        <div className="flex items-center space-x-4"> {/* Conteneur pour le fil d'Ariane et les icônes */}
          <div className="text-sm text-gray-500"> {/* Fil d'Ariane */}
            {activeItem} {/* Affiche l'élément actif comme fil d'Ariane */}
          </div>
