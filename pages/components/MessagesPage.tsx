    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-teal-50 p-8">
      ...
      >
        <h1 className="text-5xl font-extrabold bg-gradient-to-r from-[#6B7280] via-[#2CB3C2] to-[#1A8A97] bg-clip-text text-transparent flex justify-center items-center">
          <FaEnvelope className="mr-4 text-[#2CB3C2] animate-spin-slow" /> Messages & Notifications
        </h1>
        <motion.div
      ...
      >
        ...
        <div className="flex items-center gap-6 mb-8">
          ...
          <motion.select
            ...
            className="p-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-4 focus:ring-[#2CB3C2]/20 focus:border-[#2CB3C2] bg-white shadow-md transition-all duration-300"
              ...
              <AnimatePresence>
                {filteredNotifications.map(notif => (
                  <motion.div
                    ...
                    className={`p-6 rounded-2xl shadow-lg flex items-start space-x-4 ${
                ...
                <AnimatePresence>
                  {messages.map(msg => (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -20 }}
                      transition={{ duration: 0.4 }}
                      className={`p-6 rounded-2xl shadow-lg flex items-center justify-between cursor-pointer ${
                ...
                {selectedMessage ? (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      className="mt-6 bg-gradient-to-r from-[#2CB3C2] to-[#1A8A97] text-white px-6 py-2 rounded-xl shadow-lg hover:from-[#1A8A97] hover:to-[#2CB3C2] transition-all duration-300"
