...
const Sidebar: React.FC<SidebarProps> = ({ sidebarOpen, toggleSidebar }) => {
  ...
  return (
    <motion.aside
      ...
      className="bg-[#2C6E78] text-white px-2 sm:px-4 py-4 flex flex-col fixed h-screen z-30 shadow-lg font-roboto"
    >
      ...
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        ...
        >
          <img src={logo} alt="Logo" className="w-8 sm:w-10 h-8 sm:h-10" />
        </motion.div>
        <motion.button
